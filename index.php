...
<p>
  ...
  <select name="k<?php echo $i ?>" id="upages">
    <?php
    
            echo '<option value="'.$postResult["page_id"].'">'.$postResult["name"].'</option>'; $i++;
        
    ?>

  </select><?php } ?>
  <select name="nbr" id="upages3">
